...
outfitter_enabled = '1' --CreateClientConVar("outfitter_enabled","1",true,true)
...
do
	...
	function IsEnabled()
		return true --outfitter_enabled:GetBool()
	end
end
...
do
	...
	local outfitter_distance = CreateClientConVar("outfitter_distance","1500",true)
...
--TODO
outfitter_maxsize = CreateClientConVar("outfitter_maxsize","10",true)
