...
cats.mysqlite.Username         = "gmodrp"             -- The username to log in on the MySQL server
cats.mysqlite.Password         = "ohThisRoleplay"             -- The password to log in on the MySQL server
cats.mysqlite.Database_name    = "gmod_school"         -- The name of the Database on the MySQL server
...
function cats:SavePlayer(ply, callback)
    ...
    if data then
        data.playTimeTotal = ply:GetUTimeTotalTime()
...
-- init admin
hook.Add( "serverguard.LoadedPlayerData", "cats", function(ply, steamID)
        ...
        cats:Query([[
            ...
            if res then
                ...
                ply.cats_adminData = {
                    ...
                    lastNick = ply:Name(),
                    createdTime = os.time(),
                    playTimeTotal = ply:GetUTimeTotalTime(),
