...
SKIN.PrintName		= "School 666 Derma Skin"
SKIN.Author		= "chelog & quillin"
SKIN.DermaVersion	= 1
SKIN.GwenTexture	= Material( "gwenskin/srpdefault.png" )
...
derma.DefineSkin( "SRPDefault", "School 666 skin", SKIN )

hook.Add("ForceDermaSkin", "SRPSkin", function()
	return "SRPDefault"
end)
