...
if ( CLIENT ) then
	...
	language.Add( "Tool.stackerv2.name", "Stacker v2" )
	language.Add( "Tool.stackerv2.desc", "Allows you to easily stack props" )
...
CreateConVar( "stackerv2_force_nocollide",   1, bit.bor( FCVAR_NOTIFY, FCVAR_REPLICATED, FCVAR_SERVER_CAN_EXECUTE ) ) -- determines whether props should be forced to spawn nocollided or not
...
function TOOL.BuildCPanel( cpanel )
	cpanel:AddControl( "Header", { Text = "#Tool.stackerv2.name", Description	= "#Tool.stackerv2.desc" } )
	
	cpanel:AddControl( "Checkbox", { Label = "Weld stacked props",       Command = "stackerv2_weld" } )

	local params = { Label = "Stack relative to:", MenuButton = "0", Options = {} }
	params.Options[ "World" ] = { stackerv2_mode = "1" }
	params.Options[ "Prop" ]  = { stackerv2_mode = "2" }
	cpanel:AddControl( "ComboBox", params )

	local params = { Label = "Stack direction", MenuButton = "0", Options = {} }
	params.Options[ "Up" ]     = { stackerv2_dir = DIRECTION_UP }
	params.Options[ "Down" ]   = { stackerv2_dir = DIRECTION_DOWN }
	params.Options[ "Front" ]  = { stackerv2_dir = DIRECTION_FRONT }
	params.Options[ "Behind" ] = { stackerv2_dir = DIRECTION_BEHIND }
	params.Options[ "Right" ]  = { stackerv2_dir = DIRECTION_RIGHT }
	params.Options[ "Left" ]   = { stackerv2_dir = DIRECTION_LEFT }
	cpanel:AddControl( "ComboBox", params )
	...
	cpanel:AddControl( "Button", { Label = "Reset offsets and rotations", Command = "stackerv2_resetoffsets", Text = "Reset" } )
	
	cpanel:AddControl( "Slider", { Label = "Offset X ( forward/back )", Type = "Float", Min = - GetConVarNumber( "stackerv2_max_offsetx" ), Max = GetConVarNumber( "stackerv2_max_offsetx" ), Value = 0, Command = "stackerv2_offsetx" } )
	cpanel:AddControl( "Slider", { Label = "Offset Y ( right/left )",   Type = "Float", Min = - GetConVarNumber( "stackerv2_max_offsety" ), Max = GetConVarNumber( "stackerv2_max_offsety" ), Value = 0, Command = "stackerv2_offsety" } )
	cpanel:AddControl( "Slider", { Label = "Offset Z ( up/down )",      Type = "Float", Min = - GetConVarNumber( "stackerv2_max_offsetz" ), Max = GetConVarNumber( "stackerv2_max_offsetz" ), Value = 0, Command = "stackerv2_offsetz" } )
	...
	cpanel:AddControl( "Checkbox", { Label = "Stack relative to new rotation", Command = "stackerv2_recalc",    Description = "Stacks each prop relative to the prop right before it. This allows you to create curved stacks." } )
	cpanel:AddControl( "Checkbox", { Label = "Apply material",                 Command = "stackerv2_material",  Description = "Applies the material of the original prop to all stacked props" } )
	cpanel:AddControl( "Checkbox", { Label = "Apply color",                    Command = "stackerv2_color",     Description = "Applies the color of the original prop to all stacked props" } )
	cpanel:AddControl( "Checkbox", { Label = "Apply physical properties",      Command = "stackerv2_physprop",  Description = "Applies the physical properties of the original prop to all stacked props" } )
	cpanel:AddControl( "Checkbox", { Label = "Ghost all props in the stack",   Command = "stackerv2_ghostall",  Description = "Creates every ghost prop in the stack instead of just the first ghost prop" } )
	cpanel:AddControl( "Checkbox", { Label = "Add halos to ghosted props",     Command = "stackerv2_halo",      Description = "Gives halos to all of the props in to ghosted stack" } )
	cpanel:AddControl( "Color", { Label = "Halo color", Red = "stackerv2_halo_r", Green = "stackerv2_halo_g", Blue = "stackerv2_halo_b", Alpha = "stackerv2_halo_a" } )
end