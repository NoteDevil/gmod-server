...
ULogs.MySQLite_config.EnableMySQL      = true                  -- Set to true if you want to use an external MySQL database, false if you want to use the built in SQLite database (garrysmod/sv.db) of Garry's mod

ULogs.MySQLite_config.Host             = "127.0.0.1"            -- The IP address of the MySQL host
ULogs.MySQLite_config.Username         = "gmodrp"             -- The username to log in on the MySQL server
ULogs.MySQLite_config.Password         = "ohThisRoleplay"             -- The password to log in on the MySQL server

ULogs.MySQLite_config.Database_name    = "gmod_school"         -- The name of the Database on the MySQL server
