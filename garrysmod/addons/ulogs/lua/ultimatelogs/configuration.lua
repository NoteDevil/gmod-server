...
ULogs.config.Title          = "Логи - Школа 666"          -- The addon name

ULogs.config.TableName      = "ulogs"                  -- The database table name

ULogs.config.Lines          = 40                       -- Set how many lines are visible per page

ULogs.config.ChatCommand    = "!logs"                  -- Set the chat command to open the logs menu
ULogs.config.ConCommand     = "logs"                  -- Set the console command to open the logs menu
