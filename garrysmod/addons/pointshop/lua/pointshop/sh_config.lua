...
PS.Config.CommunityName = "Магазин"
...
PS.Config.CalculateSellPrice = function(ply, item)
	return math.Round(item.Price * 0.5) -- 75% or 3/4 (rounded) of the original item price
end

PS.Config.DonateButtonPressed = function()
	gui.OpenURL( "http://www.octothorp.team/ru/?p=donate&order=3&steamid=" .. LocalPlayer():SteamID() )
end
