...
local function TPToPos(ply, cmd, args)
    ...
    local maxCoord = 10000
    local pos = Vector(math.Clamp(tonumber(x), -maxCoord, maxCoord), math.Clamp(tonumber(y), -maxCoord, maxCoord), math.Clamp(tonumber(z), -maxCoord, maxCoord))
